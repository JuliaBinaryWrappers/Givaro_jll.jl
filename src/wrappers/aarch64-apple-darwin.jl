# Autogenerated wrapper script for Givaro_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(libgivaro, "@rpath/libgivaro.9.dylib")
function __init__()
